...
class UtilizadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilizador" do
    assert_difference('Utilizador.count') do
      post utilizadors_url, params: { utilizador: { email: @utilizador.email, nif: @utilizador.nif, nome_completo: @utilizador.nome_completo, turma_id: @utilizador.turma_id } }
    end
  ...
  test "should update utilizador" do
    patch utilizador_url(@utilizador), params: { utilizador: { email: @utilizador.email, nif: @utilizador.nif, nome_completo: @utilizador.nome_completo, turma_id: @utilizador.turma_id } }
